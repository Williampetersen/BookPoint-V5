	...
	return (
		<>
			<InspectorControls>
						...
						options={ [
							{
								value: 'button',
								label: __(
									'Button that opens the booking window',
									'pointly-booking'
								),
							},
							{
				...
				<PanelBody
					title={ __( 'Preselect', 'pointly-booking' ) }
					initialOpen={ false }
				>
					...
					<TextControl
						...
						help={ __(
							'Optional. The calendar opens on this date.',
							'pointly-booking'
						) }
						value={ defaultDate }
						onChange={ ( value ) =>
							setAttributes( { defaultDate: value } )
						}
						__nextHasNoMarginBottom
					/>
				</PanelBody>
				<PanelBody
					title={ __( 'Form fields', 'pointly-booking' ) }
					initialOpen={ false }
				>
					<ToggleControl
						label={ __(
			...
			<div { ...blockProps }>
				<div className="pbk-block-preview__card">
					<div className="pbk-block-preview__head">
						<span className="pbk-block-preview__badge">
							{ __( 'Booking form', 'pointly-booking' ) }
						</span>
						<span className="pbk-block-preview__mode">
							{ display === 'inline'
								...
								: __( 'Opens in a window', 'pointly-booking' ) }
						</span>
					</div>
					{ display === 'inline' ? (
						<div
							className="pbk-block-preview__inline"
							aria-hidden="true"
						>
							<span />
							<span />
						...
						<span className="pbk-block-preview__button">
							{ buttonLabel }
						</span>
					) }
					{ service && (
