...
<?php
  $actions_html = '<a class="bp-top-btn" href="' . esc_url(admin_url('admin.php?page=pointlybooking_promo_codes&action=edit')) . '">' . esc_html__('Add New', 'bookpoint') . '</a>';
  pointlybooking_render_legacy_shell_start(esc_html__('Promo Codes', 'bookpoint'), esc_html__('Create and manage discount codes.', 'bookpoint'), $actions_html, 'promo');
?>
    ...
    <tbody>
      ...
      <?php else: foreach ($items as $row): ?>
        <tr>
          ...
          <td><?php echo ((int)$row['is_active'] === 1) ? 'Ã¢Å“â€¦' : 'Ã¢â‚¬â€'; ?></td>
          <td>
