...
add_action('rest_api_init', function () {
  register_rest_route('pointly-booking/v1', '/front/settings', [
    'methods' => 'GET',
    'callback' => function () {
      $is_pro = class_exists('BPV5_BookPoint_Core_Plugin') && method_exists('BPV5_BookPoint_Core_Plugin', 'is_pro_enabled') ? BPV5_BookPoint_Core_Plugin::is_pro_enabled() : (defined('POINTLYBOOKING_IS_PRO') && POINTLYBOOKING_IS_PRO);
      ...
      $stripe_publishable = get_option('pointlybooking_stripe_publishable_key', '');
