...
<div class="bp-admin-wrap">
  ...
  <div class="bp-kpi-grid">
    ...
    <div class="bp-card">
      ...
      <div class="bp-kpi-value">Ã¢â€šÂ¬ <?php echo esc_html(pointlybooking_fmt_money($kpis['revenue'])); ?></div>
          ...
          <?php foreach ($pending as $p): ?>
            <div style="border:1px solid #e5e7eb;border-radius:14px;padding:12px;">
              <div style="display:flex;justify-content:space-between;gap:10px;align-items:flex-start;">
                <div>
                  <strong>#<?php echo esc_html((string)(int)$p['id']); ?> Ã¢â‚¬â€ <?php echo esc_html($p['customer_name']); ?></strong>
                ...
                <div><strong>Ã¢â€šÂ¬ <?php echo esc_html(pointlybooking_fmt_money($p['total_price'] ?? 0)); ?></strong></div>
              </div>
          ...
          <tbody>
            <?php foreach ($top_services as $r): ?>
              <tr>
                ...
                <td>Ã¢â€šÂ¬ <?php echo esc_html(pointlybooking_fmt_money($r['revenue'])); ?></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
      ...
      <tbody>
        ...
        <?php else: foreach ($recent as $b): ?>
          <tr>
            ...
            <td>Ã¢â€šÂ¬ <?php echo esc_html(pointlybooking_fmt_money($b['total_price'] ?? 0)); ?></td>
          </tr>
