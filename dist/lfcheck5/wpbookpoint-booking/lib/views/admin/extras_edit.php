...
$actions_html = '<a class="bp-top-btn" href="' . esc_url(admin_url('admin.php?page=pointlybooking_extras')) . '">' . esc_html__('Back to Extras', 'bookpoint') . '</a>';
...
?>
  ...
  <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <table class="form-table">
      ...
      <tr>
        ...
        <td>
          ...
          <button type="button" class="button" id="pointlybooking_extra_pick_image"><?php echo esc_html__('Choose Image', 'bookpoint'); ?></button>
          <button type="button" class="button" id="pointlybooking_extra_remove_image"><?php echo esc_html__('Remove', 'bookpoint'); ?></button>
        </td>
      </tr>
    ...
    <p class="submit">
      ...
      <?php if ($id): ?>
        <a class="bp-btn bp-btn-danger" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=pointlybooking_extras_delete&id=' . absint($id)), 'pointlybooking_admin')); ?>" onclick="return confirm('<?php echo esc_js(__('Delete extra?', 'bookpoint')); ?>');">
