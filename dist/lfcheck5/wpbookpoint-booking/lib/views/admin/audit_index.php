...
pointlybooking_render_legacy_shell_start(esc_html__('Audit Log', 'bookpoint'), esc_html__('Review system activity and changes.', 'bookpoint'), '', 'audit');
?>
  ...
  <form method="get" style="margin:12px 0;">
    ...
    <a class="button" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_audit')); ?>"><?php esc_html_e('Reset', 'bookpoint'); ?></a>
  </form>
