...
<div class="bp-admin-wrap">
  ...
  <div class="bp-kpi-grid">
    ...
    <div class="bp-card">
      ...
      <div class="bp-kpi-value">Ã¢â€šÂ¬ <?php echo esc_html(pointlybooking_fmt_money($kpis['revenue_7d'])); ?></div>
      <div class="bp-kpi-foot"><?php echo esc_html($kpis['since7'] . ' Ã¢â€ â€™ ' . $kpis['today']); ?></div>
    </div>
    ...
    <div class="bp-card">
      ...
      <div class="bp-kpi-foot"><?php echo esc_html($kpis['since30'] . ' Ã¢â€ â€™ ' . $kpis['today']); ?></div>
    </div>
  </div>
