    ...
    <tbody>
      ...
      <?php else: foreach ($items as $row): ?>
        <tr>
          ...
          <td><?php echo ((int)$row['required'] === 1) ? 'âœ…' : 'â€”'; ?></td>
          <td><?php echo ((int)$row['is_active'] === 1) ? 'âœ…' : 'â€”'; ?></td>
          <td>
            <a class="button button-small" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_form_fields&scope='.$scope.'&action=edit&id='.(int)$row['id'])); ?>">
