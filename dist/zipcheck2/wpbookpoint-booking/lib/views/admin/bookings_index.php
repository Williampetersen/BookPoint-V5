...
<div class="wrap">
  ...
  <form method="get" style="margin:12px 0;">
    ...
    <a class="button" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_bookings')); ?>"><?php esc_html_e('Reset', 'bookpoint'); ?></a>
    <?php
      $safe_query = [];
      ...
      $export_url = wp_nonce_url(
        add_query_arg(array_merge($safe_query, ['action' => 'pointlybooking_admin_bookings_export_csv']), admin_url('admin-post.php')),
