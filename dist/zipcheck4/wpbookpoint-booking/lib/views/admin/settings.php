...
pointlybooking_render_legacy_shell_start(esc_html__('BookPoint Settings', 'bookpoint'), esc_html__('Configure global settings and integrations.', 'bookpoint'), '', 'settings');
?>

  <h2 class="nav-tab-wrapper">
    <a class="nav-tab <?php echo $tab === 'general' ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=general')); ?>"><?php esc_html_e('General', 'bookpoint'); ?></a>
    <a class="nav-tab <?php echo $tab === 'emails' ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=emails')); ?>"><?php esc_html_e('Emails', 'bookpoint'); ?></a>
    <a class="nav-tab <?php echo $tab === 'webhooks' ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=webhooks')); ?>"><?php esc_html_e('Webhooks', 'bookpoint'); ?></a>
    <a class="nav-tab <?php echo $tab === 'import_export' ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=import_export')); ?>"><?php esc_html_e('Import / Export', 'bookpoint'); ?></a>
  </h2>
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
      ...
      <input type="hidden" name="tab" value="<?php echo esc_attr($tab); ?>">
              ...
              <table class="form-table" role="presentation">
                <tr>
                  <th><label for="pointlybooking_open"><?php echo esc_html__('Open time', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_close"><?php echo esc_html__('Close time', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_interval"><?php echo esc_html__('Slot interval (minutes)', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_currency"><?php echo esc_html__('Default currency', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_currency_position"><?php echo esc_html__('Currency position', 'bookpoint'); ?></label></th>
                  <td>
              ...
              <table class="form-table" role="presentation">
                <tr>
                  <th><label for="pointlybooking_future_days"><?php esc_html_e('Booking limit (days ahead)', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_breaks"><?php esc_html_e('Daily breaks', 'bookpoint'); ?></label></th>
                  <td>
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                      ...
                      <tr>
                        ...
                        <td style="padding:8px;border:1px solid #ddd;">
                          ...
                          <?php pointlybooking_err($errors, 'schedule_' . $i); ?>
                        </td>
                      </tr>
                      <?php endfor; ?>
                    </table>
              ...
              <table class="form-table" role="presentation">
                ...
                <tr>
                  <th><label for="pointlybooking_admin_email"><?php esc_html_e('Admin email', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_from_name"><?php esc_html_e('From name', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_from_email"><?php esc_html_e('From email', 'bookpoint'); ?></label></th>
                  <td>
              ...
              <table class="form-table" role="presentation">
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_secret"><?php esc_html_e('Webhook secret', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_created"><?php esc_html_e('Booking created URL', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_status_changed"><?php esc_html_e('Booking status changed URL', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_updated"><?php esc_html_e('Booking updated URL', 'bookpoint'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_cancelled"><?php esc_html_e('Booking cancelled URL', 'bookpoint'); ?></label></th>
                  <td>
