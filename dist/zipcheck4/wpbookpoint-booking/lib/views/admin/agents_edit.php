...
$actions_html = '<a class="bp-top-btn" href="' . esc_url(admin_url('admin.php?page=pointlybooking_agents')) . '">' . esc_html__('Back to Agents', 'bookpoint') . '</a>';
    ...
    <table class="form-table" role="presentation">
      ...
      <tr>
        ...
        <td>
          ...
          <button type="button" class="button" id="pointlybooking_agent_pick_image"><?php echo esc_html__('Choose Image', 'bookpoint'); ?></button>
          <button type="button" class="button" id="pointlybooking_agent_remove_image"><?php echo esc_html__('Remove', 'bookpoint'); ?></button>
