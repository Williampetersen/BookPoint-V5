...
function pointlybooking_extras_table_public() {
  // Ã¢Å¡Â Ã¯Â¸Â change if your extras table name is different
...
function pointlybooking_rest_public_extras(WP_REST_Request $req) {
  ...
  $t = $wpdb->prefix . pointlybooking_extras_table_public();
  $t_rel = $wpdb->prefix . 'pointlybooking_extra_services';
