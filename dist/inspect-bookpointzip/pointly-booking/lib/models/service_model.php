...
final class POINTLYBOOKING_ServiceModel extends POINTLYBOOKING_Model {
  ...
  public static function get_category_ids(int $service_id): array {
    ...
    // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- table name is generated from hardcoded suffix via pointlybooking_table().
  ...
  public static function all(array $args = []) : array {
    ...
    $list = $wpdb->get_results(
      $wpdb->prepare(
        // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared, PluginCheck.Security.DirectDB.UnescapedDBParameter -- table name is generated from hardcoded suffix via pointlybooking_table(); $where contains only hardcoded SQL fragments with placeholders.
        "SELECT * FROM {$table} {$where} AND %d=%d ORDER BY id DESC",
        $params
      ),
      ARRAY_A
    );
