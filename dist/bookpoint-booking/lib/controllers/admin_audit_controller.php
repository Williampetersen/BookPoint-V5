...
final class POINTLYBOOKING_AdminAuditController extends POINTLYBOOKING_Controller {
  ...
  public function index() : void {
    ...
    $date_from = $has_filter_nonce ? $this->sanitize_ymd((string) wp_unslash($_GET['date_from'] ?? '')) : '';
    $date_to = $has_filter_nonce ? $this->sanitize_ymd((string) wp_unslash($_GET['date_to'] ?? '')) : '';
