...
?>
<?php
$actions_html = '<a class="bp-top-btn" href="' . esc_url(admin_url('admin.php?page=pointlybooking_services')) . '">' . esc_html__('Back to Services', 'bookpoint') . '</a>';
pointlybooking_render_legacy_shell_start(
  $id ? esc_html__('Edit Service', 'bookpoint') : esc_html__('Add Service', 'bookpoint'),
  esc_html__('Manage service details, pricing, and availability.', 'bookpoint'),
  $actions_html,
  'services'
);
?>
  ...
  <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <table class="form-table" role="presentation">
      <tr>
        <th><label for="pointlybooking_name"><?php echo esc_html__('Name', 'bookpoint'); ?></label></th>
        <td>
      ...
      <tr>
        <th><label for="pointlybooking_duration"><?php echo esc_html__('Duration (minutes)', 'bookpoint'); ?></label></th>
        <td>
      ...
      <tr>
        <th><label for="pointlybooking_price"><?php echo esc_html__('Price (cents)', 'bookpoint'); ?></label></th>
        <td>
      ...
      <tr>
        <th><label for="pointlybooking_currency"><?php echo esc_html__('Currency', 'bookpoint'); ?></label></th>
        <td>
      ...
      <tr>
        ...
        <td>
          ...
          <button type="button" class="button" id="pointlybooking_service_pick_image"><?php echo esc_html__('Choose Image', 'bookpoint'); ?></button>
          <button type="button" class="button" id="pointlybooking_service_remove_image"><?php echo esc_html__('Remove', 'bookpoint'); ?></button>
      ...
      <tr>
        <th><label for="pointlybooking_capacity"><?php echo esc_html__('Capacity', 'bookpoint'); ?></label></th>
        <td>
      ...
      <tr>
        <th><label for="pointlybooking_buf_before"><?php echo esc_html__('Buffer before (minutes)', 'bookpoint'); ?></label></th>
        <td>
      ...
      <tr>
        <th><label for="pointlybooking_buf_after"><?php echo esc_html__('Buffer after (minutes)', 'bookpoint'); ?></label></th>
        <td>
    ...
    <p class="submit">
      ...
      <a class="bp-btn" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_services')); ?>"><?php echo esc_html__('Back', 'bookpoint'); ?></a>
      <?php if ($id): ?>
        <a class="bp-btn bp-btn-danger" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=pointlybooking_services_delete&id=' . absint($id)), 'pointlybooking_admin')); ?>" onclick="return confirm('<?php echo esc_js(__('Delete service?', 'bookpoint')); ?>');">
