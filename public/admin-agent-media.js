(function(){
  document.addEventListener('DOMContentLoaded', function(){
    const pickBtn = document.getElementById('bp_agent_pick_image');
    const removeBtn = document.getElementById('bp_agent_remove_image');
    const input = document.getElementById('bp_agent_image_id');
    const preview = document.getElementById('bp_agent_image_preview');
