(function(){
  document.addEventListener('DOMContentLoaded', function(){
    const pickBtn = document.getElementById('bp_extra_pick_image');
    const removeBtn = document.getElementById('bp_extra_remove_image');
    const input = document.getElementById('bp_extra_image_id');
    const preview = document.getElementById('bp_extra_image_preview');
