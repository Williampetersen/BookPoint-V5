...
<div class="bp-wrap">
  <div class="bp-card">
    <h2 class="bp-h2"><?php esc_html_e('Verify Code', 'bookpoint-booking'); ?></h2>
    <p class="bp-p"><?php
      /* translators: %s: Customer email address. */
      /* translators: %s: Customer email address. */
      echo esc_html(sprintf(__('We sent a code to %s', 'bookpoint-booking'), $email));
    ?></p>
    ...
    <form method="post" class="bp-row">
      ...
      <div class="bp-field">
        <label><?php esc_html_e('6-digit code', 'bookpoint-booking'); ?></label>
      ...
      <div class="bp-field" style="justify-content:flex-end;">
        <button class="bp-btn" type="submit" name="pointlybooking_portal_action" value="verify_otp">
          <?php esc_html_e('Login', 'bookpoint-booking'); ?>
        </button>
      </div>
    </form>
  </div>
