...
pointlybooking_render_legacy_shell_start(esc_html__('BookPoint Settings', 'bookpoint-v5'), esc_html__('Configure global settings and integrations.', 'bookpoint-v5'), '', 'settings');
?>

  <h2 class="nav-tab-wrapper">
    <a class="nav-tab <?php echo esc_attr($pointlybooking_tab === 'general' ? 'nav-tab-active' : ''); ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=general')); ?>"><?php esc_html_e('General', 'bookpoint-v5'); ?></a>
    <a class="nav-tab <?php echo esc_attr($pointlybooking_tab === 'emails' ? 'nav-tab-active' : ''); ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=emails')); ?>"><?php esc_html_e('Emails', 'bookpoint-v5'); ?></a>
    <a class="nav-tab <?php echo esc_attr($pointlybooking_tab === 'webhooks' ? 'nav-tab-active' : ''); ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=webhooks')); ?>"><?php esc_html_e('Webhooks', 'bookpoint-v5'); ?></a>
    <a class="nav-tab <?php echo esc_attr($pointlybooking_tab === 'import_export' ? 'nav-tab-active' : ''); ?>" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings&tab=import_export')); ?>"><?php esc_html_e('Import / Export', 'bookpoint-v5'); ?></a>
  </h2>

  <?php if ($pointlybooking_updated) : ?>
    <div class="notice notice-success is-dismissible"><p><?php echo esc_html__('Settings saved.', 'bookpoint-v5'); ?></p></div>
  <?php endif; ?>
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
      ...
      <input type="hidden" name="tab" value="<?php echo esc_attr($pointlybooking_tab); ?>">
              ...
              <table class="form-table" role="presentation">
                <tr>
                  <th><label for="pointlybooking_open"><?php echo esc_html__('Open time', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_close"><?php echo esc_html__('Close time', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_interval"><?php echo esc_html__('Slot interval (minutes)', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_currency"><?php echo esc_html__('Default currency', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_currency_position"><?php echo esc_html__('Currency position', 'bookpoint-v5'); ?></label></th>
                  <td>
                    <select id="pointlybooking_currency_position" name="currency_position">
                      <option value="before" <?php selected($currency_position ?? 'before', 'before'); ?>><?php echo esc_html__('Before amount', 'bookpoint-v5'); ?></option>
                      <option value="after" <?php selected($currency_position ?? 'before', 'after'); ?>><?php echo esc_html__('After amount', 'bookpoint-v5'); ?></option>
                    </select>
              ...
              <h2><?php esc_html_e('Availability & Scheduling', 'bookpoint-v5'); ?></h2>
              <table class="form-table" role="presentation">
                <tr>
                  <th><label for="pointlybooking_future_days"><?php esc_html_e('Booking limit (days ahead)', 'bookpoint-v5'); ?></label></th>
                  <td>
                    ...
                    <p class="description"><?php esc_html_e('Customers can only book up to this many days in advance', 'bookpoint-v5'); ?></p>
                    <?php pointlybooking_err($errors,'future_days_limit'); ?>
                  </td>
                </tr>

                <tr>
                  <th><label for="pointlybooking_breaks"><?php esc_html_e('Daily breaks', 'bookpoint-v5'); ?></label></th>
                  <td>
                    ...
                    <p class="description"><?php esc_html_e('Comma-separated break times (e.g., 12:00-13:00,15:00-15:15)', 'bookpoint-v5'); ?></p>
                    <?php pointlybooking_err($errors,'breaks'); ?>
                  </td>
                </tr>
              </table>

              <h2><?php esc_html_e('Weekly Schedule', 'bookpoint-v5'); ?></h2>
              <table class="form-table" role="presentation">
                <tr>
                  <td colspan="2">
                    <table style="width:100%;border-collapse:collapse;">
                      <tr style="background:#f1f1f1;">
                        <th style="padding:8px;border:1px solid #ddd;text-align:left;"><?php esc_html_e('Day', 'bookpoint-v5'); ?></th>
                        <th style="padding:8px;border:1px solid #ddd;text-align:left;"><?php esc_html_e('Hours', 'bookpoint-v5'); ?></th>
                      </tr>
                      <?php 
                    ...
                    <p class="description" style="margin-top:10px;"><?php esc_html_e('Leave empty for closed days. Format: HH:MM-HH:MM (e.g., 09:00-17:00)', 'bookpoint-v5'); ?></p>
                  </td>
                </tr>
              </table>

              <h2><?php esc_html_e('Uninstall', 'bookpoint-v5'); ?></h2>
              <table class="form-table" role="presentation">
                <tr>
                  <th><?php esc_html_e('Remove data on uninstall', 'bookpoint-v5'); ?></th>
                  <td>
                    <label>
                      <input type="checkbox" name="pointlybooking_remove_data_on_uninstall" value="1" <?php checked((int)($remove_data_on_uninstall ?? 0), 1); ?>>
                      <?php esc_html_e('Delete all BookPoint data when the plugin is uninstalled.', 'bookpoint-v5'); ?>
                    </label>
                  </td>
                </tr>
              </table>
              ...
              <h2><?php esc_html_e('Email Notifications', 'bookpoint-v5'); ?></h2>
              <table class="form-table" role="presentation">
                <tr>
                  <th><?php esc_html_e('Enable Emails', 'bookpoint-v5'); ?></th>
                  <td>
                    <label>
                      <input type="checkbox" name="email_enabled" value="1" <?php checked((int)$email_enabled, 1); ?>>
                      <?php esc_html_e('Send email notifications for bookings', 'bookpoint-v5'); ?>
                    </label>
                  </td>
                </tr>

                <tr>
                  <th><label for="pointlybooking_admin_email"><?php esc_html_e('Admin email', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_from_name"><?php esc_html_e('From name', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_from_email"><?php esc_html_e('From email', 'bookpoint-v5'); ?></label></th>
                  <td>
              ...
              <h2><?php esc_html_e('Webhooks', 'bookpoint-v5'); ?></h2>
              <table class="form-table" role="presentation">
                <tr>
                  <th><?php esc_html_e('Enable Webhooks', 'bookpoint-v5'); ?></th>
                  <td>
                    <label>
                      <input type="checkbox" name="webhooks_enabled" value="1" <?php checked((int)$webhooks_enabled, 1); ?>>
                      <?php esc_html_e('Send webhook events for bookings', 'bookpoint-v5'); ?>
                    </label>
                  </td>
                </tr>
                <tr>
                  <th><label for="pointlybooking_webhook_secret"><?php esc_html_e('Webhook secret', 'bookpoint-v5'); ?></label></th>
                  <td>
                    ...
                    <p class="description"><?php esc_html_e('Used to sign webhook payloads (optional).', 'bookpoint-v5'); ?></p>
                  </td>
                </tr>
                <tr>
                  <th><label for="pointlybooking_webhook_booking_created"><?php esc_html_e('Booking created URL', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_status_changed"><?php esc_html_e('Booking status changed URL', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_updated"><?php esc_html_e('Booking updated URL', 'bookpoint-v5'); ?></label></th>
                  <td>
                ...
                <tr>
                  <th><label for="pointlybooking_webhook_booking_cancelled"><?php esc_html_e('Booking cancelled URL', 'bookpoint-v5'); ?></label></th>
                  <td>
              ...
              <p class="submit">
                <button type="submit" class="button button-primary"><?php echo esc_html__('Save Settings', 'bookpoint-v5'); ?></button>
              </p>
            </form>
          <?php endif; ?>
          ...
          <?php if ($pointlybooking_tab === 'import_export') : ?>
            <div style="max-width:900px;">
              <h2><?php esc_html_e('Import / Export', 'bookpoint-v5'); ?></h2>

              <h3><?php esc_html_e('Export settings', 'bookpoint-v5'); ?></h3>
              <p class="description"><?php esc_html_e('Downloads a JSON file with BookPoint settings.', 'bookpoint-v5'); ?></p>
              <?php
              ...
              ?>
              <a class="button button-primary" href="<?php echo esc_url($pointlybooking_export_url); ?>"><?php esc_html_e('Export JSON', 'bookpoint-v5'); ?></a>

              <hr>

              <h3><?php esc_html_e('Import settings', 'bookpoint-v5'); ?></h3>
              <p class="description"><?php esc_html_e('Upload a previously exported JSON file. Only whitelisted settings keys are imported.', 'bookpoint-v5'); ?></p>
              ...
              <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" enctype="multipart/form-data">
                ...
                <button class="button" type="submit" onclick="return confirm('Import settings JSON?');">
                  <?php esc_html_e('Import JSON', 'bookpoint-v5'); ?>
                </button>
              </form>

              <?php if ($pointlybooking_import !== '') : ?>
                <p style="margin-top:12px;">
                  <strong><?php echo esc_html__('Import result:', 'bookpoint-v5'); ?></strong>
