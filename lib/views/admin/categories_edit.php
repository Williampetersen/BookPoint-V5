...
$pointlybooking_actions_html = '<a class="bp-top-btn" href="' . esc_url(admin_url('admin.php?page=pointlybooking_categories')) . '">' . esc_html__('Back to Categories', 'bookpoint-v5') . '</a>';
pointlybooking_render_legacy_shell_start(
  $id ? esc_html__('Edit Category', 'bookpoint-v5') : esc_html__('Add Category', 'bookpoint-v5'),
  esc_html__('Create and organize service categories.', 'bookpoint-v5'),
  ...
  <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <table class="form-table">
      ...
      <tr>
        ...
        <td>
          ...
          <button type="button" class="button" id="pointlybooking_pick_image"><?php echo esc_html__('Choose Image', 'bookpoint-v5'); ?></button>
          <button type="button" class="button" id="pointlybooking_remove_image"><?php echo esc_html__('Remove', 'bookpoint-v5'); ?></button>
    ...
    <p class="submit">
      <button type="submit" class="bp-btn bp-btn-primary">
        <?php echo esc_html($id ? __('Save Changes', 'bookpoint-v5') : __('Create Category', 'bookpoint-v5')); ?>
      </button>
      ...
      <?php if ($id): ?>
        <a class="bp-btn bp-btn-danger" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=pointlybooking_categories_delete&id=' . absint($id)), 'pointlybooking_admin')); ?>" onclick="return confirm('<?php echo esc_js(__('Delete category?', 'bookpoint-v5')); ?>');">
