...
<div class="bp-admin-wrap">
  <div class="bp-admin-head">
    <div>
      ...
      <div class="bp-admin-sub"><?php echo esc_html__('Overview of bookings and performance.', 'bookpoint-v5'); ?></div>
    </div>
    ...
    <div class="bp-admin-actions">
      <a class="bp-btn secondary" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_bookings')); ?>">
        <?php echo esc_html__('Manage Bookings', 'bookpoint-v5'); ?>
      </a>
      <a class="bp-btn" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_services')); ?>">
        <?php echo esc_html__('Add Service', 'bookpoint-v5'); ?>
      </a>
    </div>
  </div>
  ...
  <div class="bp-kpi-grid">
    <div class="bp-card">
      <div class="bp-kpi-label"><?php echo esc_html__('Bookings Today', 'bookpoint-v5'); ?></div>
    ...
    <div class="bp-card">
      ...
      <div class="bp-kpi-foot"><?php echo esc_html__('Needs confirmation', 'bookpoint-v5'); ?></div>
    </div>

    <div class="bp-card">
      <div class="bp-kpi-label"><?php echo esc_html__('Revenue (7 days)', 'bookpoint-v5'); ?></div>
    ...
    <div class="bp-card">
      <div class="bp-kpi-label"><?php echo esc_html__('Cancelled (30 days)', 'bookpoint-v5'); ?></div>
  ...
  <div class="bp-dash-grid">
    <div class="bp-card">
      <div class="bp-card-title"><?php echo esc_html__('Bookings (Last 14 Days)', 'bookpoint-v5'); ?></div>
      ...
      <div class="bp-chart-legend">
        <span><?php echo esc_html__('Each bar = bookings per day', 'bookpoint-v5'); ?></span>
      </div>
    </div>

    <div class="bp-card">
      <div class="bp-card-title"><?php echo esc_html__('Quick Actions', 'bookpoint-v5'); ?></div>
      <div class="bp-qa">
        <a class="bp-qa-item" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_categories')); ?>">
          <strong><?php echo esc_html__('Categories', 'bookpoint-v5'); ?></strong>
          <span><?php echo esc_html__('Manage service categories', 'bookpoint-v5'); ?></span>
        </a>
        <a class="bp-qa-item" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_services')); ?>">
          <strong><?php echo esc_html__('Services', 'bookpoint-v5'); ?></strong>
          <span><?php echo esc_html__('Create/edit services', 'bookpoint-v5'); ?></span>
        </a>
        <a class="bp-qa-item" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_extras')); ?>">
          <strong><?php echo esc_html__('Service Extras', 'bookpoint-v5'); ?></strong>
          <span><?php echo esc_html__('Add upsells & add-ons', 'bookpoint-v5'); ?></span>
        </a>
        <a class="bp-qa-item" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_agents')); ?>">
          <strong><?php echo esc_html__('Agents', 'bookpoint-v5'); ?></strong>
          <span><?php echo esc_html__('Staff and assignments', 'bookpoint-v5'); ?></span>
        </a>
        <a class="bp-qa-item" href="<?php echo esc_url(admin_url('admin.php?page=pointlybooking_settings')); ?>">
          <strong><?php echo esc_html__('Settings', 'bookpoint-v5'); ?></strong>
          <span><?php echo esc_html__('Email/webhooks/templates', 'bookpoint-v5'); ?></span>
        </a>
      </div>
    </div>
  </div>
