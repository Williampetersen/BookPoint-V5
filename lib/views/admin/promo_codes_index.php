...
<?php
  $pointlybooking_actions_html = '<a class="bp-top-btn" href="' . esc_url(admin_url('admin.php?page=pointlybooking_promo_codes&action=edit')) . '">' . esc_html__('Add New', 'bookpoint-v5') . '</a>';
  pointlybooking_render_legacy_shell_start(esc_html__('Promo Codes', 'bookpoint-v5'), esc_html__('Create and manage discount codes.', 'bookpoint-v5'), $pointlybooking_actions_html, 'promo');
?>
  ...
  <form method="get" style="margin:12px 0;">
    ...
    <input type="text" name="q" value="<?php echo esc_attr($q); ?>" placeholder="<?php echo esc_attr__('Search code...', 'bookpoint-v5'); ?>">
  ...
  <table class="widefat striped">
    <thead>
      <tr>
        <th><?php echo esc_html__('Code', 'bookpoint-v5'); ?></th>
        <th><?php echo esc_html__('Type', 'bookpoint-v5'); ?></th>
        <th><?php echo esc_html__('Amount', 'bookpoint-v5'); ?></th>
        <th><?php echo esc_html__('Uses', 'bookpoint-v5'); ?></th>
    ...
    <tbody>
      <?php if (empty($items)): ?>
        <tr><td colspan="6" style="text-align:center;"><?php echo esc_html__('No promo codes yet.', 'bookpoint-v5'); ?></td></tr>
      <?php else: foreach ($items as $row):
        ...
        <tr>
          ...
          <td><?php echo ((int)$row['is_active'] === 1) ? esc_html__('Yes', 'bookpoint-v5') : esc_html__('No', 'bookpoint-v5'); ?></td>
          <td>
